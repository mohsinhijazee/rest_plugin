...
hash[:parent_url]               = url(entity_url(:id => relation.parent_id))
hash[:child_side_type_url]      = url(relation_side_type_url(:id => relation.child_side_type_id))
hash[:parent_side_type_url]      = url(relation_side_type_url(:id => relation.parent_side_type_id))
